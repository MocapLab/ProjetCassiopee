...
sub_sample_points = ['RUPA', 'LFWT', 'LELB', 'UPHD', 'RELBEXT', 'RCLAV', 'LWRA', 'LBSHO', 'RWRB', 'LELBEXT', 'RFWT', 'LCLAV', 'LBWT', 'RWRA', 'LFSHO', 'CLAV', 'C7', 'RFHD', 'RBAC', 'LWRC', 'RBSHO', 'RBWT', 'RWRC', 'LWRB', 'T10', 'LFRM', 'RELB', 'LBAC', 'LBHD', 'RBHD', 'LFHD', 'STRN', 'RFRM', 'RFSHO', 'LSHOULD', 'LUPA', 'RSHOULD']
